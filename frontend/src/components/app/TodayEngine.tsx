...
export function TodayEngine({ tasks, habits, goals }: Props) {
  ...
  const insights = useMemo(() => {
    ...
    // goal needing attention: lowest progress, weighted by nearest target date
    const goalNeedsAttention = [...goals]
      ...
      .sort((a, b) => {
        ...
        // smaller progress + closer date = more urgent
  ...
  return (
    ...
    >
      <div className="px-6 py-5 border-b border-border bg-gradient-to-br from-primary/5 via-card to-accent/5">
